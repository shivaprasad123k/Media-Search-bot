...
async def filter(client, message):
    ...
    if AUTH_CHANNEL:
        ...
        try:
            ...
            await client.send_message(
                chat_id=message.from_user.id,
                text="**താഴെ കാണുന്ന join ബട്ടൺ ഇൽ ക്ലിക്ക് ചെയ്ത് ജോയിൻ ആകുക**",
    ...
    if 2 < len(message.text) < 100:    
        ...
        if len(btn) > 10: 
            ...
            if poster:
                ...
                await message.reply_photo(photo="https://telegra.ph/file/771c98b540947dad2725c.jpg", caption=f"<b>🍿 ᴍᴏᴠɪᴇ ɴᴀᴍᴇ : <code>{search} ‌‌‌‌‎ ­  ­  ­  ­  ­  </code>{RESULT_MSG} </b>", reply_markup=InlineKeyboardMarkup(buttons)) 
            return
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('🤴 ʙᴏᴛ ᴏɴᴡᴇʀ 🤴', url='https://t.me/OGGY123kph'),
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('💡 More Bots 💡', url='https://t.me/mallumoviesstorage'),
                        InlineKeyboardButton('♻️ Update Channel ♻️', url='https://t.me/mallumovies30')
                    ]
                    ]
